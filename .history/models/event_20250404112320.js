...
async function createEvent(title, description, latitude, longitude, dateTime, categories, userId) {
...
async function updateEvent(eventId, title, description, latitude, longitude, dateTime, categories) {
    const result = await pool.query(
