...
async function createUser(username, password, latitude, longitude, preferredCategories, language) {
    ...
    const result = await pool.query(
        ...
        [username, hashedPassword, latitude, longitude, preferredCategories, language]
    );
